...
class Movie
{
    ...
    public String[] movieName = {"taare jameen par","raazi","URI"}; 
    public static final String[] genre= {"Emotional","Action","Action"};
    public static final int No_Of_Seats[] = {90,40,60};
    public int price[] = {450,320,200};
    public Movie() {
